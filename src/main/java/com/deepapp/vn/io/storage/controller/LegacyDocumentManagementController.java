...
@RestController
@RequestMapping("/api/documents/legacy")
@Tag(name = "Document Management (Legacy)", description = "Legacy APIs for managing processed documents")
public class LegacyDocumentManagementController {
    
    private final DocumentManagementService documentService;
    
    public LegacyDocumentManagementController(DocumentManagementService documentService) {
